...
pub fn chunk_index_to_world_space(
    ...
    tile_pos_to_world_space(&anchor_tile_pos, &grid_size, map_type)
}

/// Returns the bottom-left coordinate of the tile at specified `tile_pos`, in world units.
pub fn tile_pos_to_world_space(
    tile_pos: &TilePos,
    ...
    match tilemap_type {
        ...
        TilemapType::Isometric {
            ...
            pos =
                diamond_pos_to_world_pos(tile_pos_f32.x, tile_pos_f32.y, grid_size.x, grid_size.y);
        }
        TilemapType::Isometric {
            coord_system: IsoCoordSystem::Staggered,
            ..
        } => {
            pos = staggered_pos_to_world_pos(
                tile_pos_f32.x,
                tile_pos_f32.y,
                grid_size.x,
                grid_size.y,

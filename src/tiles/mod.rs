...
use bevy::{
    math::{UVec2, Vec2},
    prelude::{Bundle, Color, Component, Reflect, FromReflect, ReflectComponent},
};
pub use storage::*;
...
#[derive(Component, Reflect, FromReflect, Default, Clone, Copy, Debug, Hash, PartialEq, Eq, PartialOrd)]
#[reflect(Component)]
pub struct TilePos {
    pub x: u32,
    pub y: u32,
